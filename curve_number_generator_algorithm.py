...
class CurveNumberGeneratorAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        # Check if CRS is acceptable for NLCD WMS
        ...
        if curve_number_output == True or nlcd_vect_output == True or nlcd_rast_output == True:
            ...
            try: # for QGIS Version later than 3.12
                ...
                feedback.reportError('You are not using the latest version of QGIS, defaulting to the old version of native algorithm \'set style layer\'.'+'\n', True)
...
<br><p align="right">Algorithm author: Abdul Raheem Siddiqui</p><p align="right">Help author: Abdul Raheem Siddiqui</p><p align="right">Algorithm version: 0.2</p><p align="right">Contact email: ars.work.ce@gmail.com</p><p>Disclaimer: The curve numbers generated with this algorithm are high level estimates and should be reviewed in detail before being used for detailed modeling or construction projects.</p></body></html>"""
